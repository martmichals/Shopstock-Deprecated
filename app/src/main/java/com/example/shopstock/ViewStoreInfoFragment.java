...
public class ViewStoreInfoFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private final Item[] items = {
        new Item("Bread", "bread", "food", -1),
        new Item("Eggs", "bread", "food", -0.9),
        new Item("Cheese", "bread", "food", -0.8),
        new Item("Eggs", "bread", "food", -0.7),
        new Item("Eggs", "bread", "food", -0.6),
        new Item("Cheese", "bread", "food", -0.5),
        new Item("Cheese", "bread", "food", -0.4),
        new Item("Bread", "bread", "food", -0.3),
        new Item("Bread", "bread", "food", -0.2),
        new Item("Bread", "bread", "food", -0.1),
        new Item("Bread", "bread", "food", 0),
        new Item("Bread", "bread", "food", 0.1),
        new Item("Bread", "bread", "food", 0.2),
        new Item("Bread", "bread", "food", 0.3),
        new Item("Bread", "bread", "food", 0.4),
        new Item("Bread", "bread", "food", 0.5),
        new Item("Bread", "bread", "food", 0.6),
        new Item("Bread", "bread", "food", 0.7),
        new Item("Bread", "bread", "food", 0.8),
        new Item("Bread", "bread", "food", 0.9),
        new Item("Bread", "bread", "food", 1)
    };
